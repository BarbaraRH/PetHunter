...
export const Footer = () => (
	<footer
		...
		<div className="row p-3 text-center" style={{ backgroundImage: "linear-gradient(#d5ffff,#a1ffce)" }}>
			<Link to="/LostPets" className="col-sm-4 col-4" style={{ color: "#81b9bf" }}>
				<i className="fas fa-search fa-2x blanco" />
			</Link>
			<Link to="/FindedPets" className="col-sm-4 col-4 blanco" style={{ color: "#81b9bf" }}>
				<i className="fas fa-bullseye fa-2x" />
			</Link>
			<Link to="/petHunterHistory" className="col-sm-4 col-4 blanco" style={{ color: "#81b9bf" }}>
